        ...
        >
          ...
          <div className="row align-items-center gy-4 position-relative" style={{ zIndex: 3 }}>
            <div className="col-lg-7">
              ...
              <div
                className="d-inline-flex align-items-center gap-2 rounded-pill px-3 py-1 fw-bold small mb-3 shadow-sm"
                style={{
              ...
              >
                ...
                <span className="fw-extrabold" style={{ color: '#FFFFFF', letterSpacing: '0.5px' }}>
